...
// Requer: Authorization: Bearer <token>  (recepcao ou admin)
...
module.exports = async function handler(req, res) {
  ...
  if (!auth.ok) return; // resposta já enviada pelo middleware

  const { nome, cpf, email, telefone, foto_url, tipo = 'aluno' } = req.body || {};
