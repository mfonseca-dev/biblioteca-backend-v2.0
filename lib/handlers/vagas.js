...
res.setHeader('Vary', 'Origin');
  ...
  // no futuro). Feito como duas contagens separadas e somadas, em vez de
  // um .or() combinado, porque filtros and()/or() aninhados com valores
  // de timestamp (que contem ':' e '.') sao instaveis no client do
  // Supabase/PostgREST.
